    ...
    public class DemoScript : MonoBehaviour
    {
        ...
        private void SwipeGestureCallback(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
            if (gesture.State == GestureRecognizerState.Ended)
            {
                GestureTouch t = FirstTouch(touches);
                HandleSwipe(t.X, t.Y);
                DebugText("Swiped from {0},{1} to {2},{3}; velocity: {4}, {5}", gesture.StartFocusX, gesture.StartFocusY, t.X, t.Y, swipeGesture.VelocityX, swipeGesture.VelocityY);
            }
        }
        ...
        private void PanGestureCallback(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
            ...
            {
                GestureTouch t = FirstTouch(touches);
                DebugText("Panned, {0}, {1}, {2}, {3}, {4}, {5}", t.X, t.Y, t.DeltaX, t.DeltaY, panGesture.DeltaX, panGesture.DeltaY);
        ...
        private void PlatformSpecificViewTapUpdated(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
            if (gesture.State == GestureRecognizerState.Ended)
            {
        ...
        private void CreatePlatformSpecificViewTripleTapGesture()
        {
            ...
            tripleTapGesture.Updated += PlatformSpecificViewTapUpdated;
        ...
        private void LateUpdate()
        {
            ...
            dpiLabel.text = "Dpi: " + DeviceInfo.PixelsPerInch + System.Environment.NewLine +
                ...
                "Touches: " + touchCount + ", ids" + touchIds + System.Environment.NewLine;
        }

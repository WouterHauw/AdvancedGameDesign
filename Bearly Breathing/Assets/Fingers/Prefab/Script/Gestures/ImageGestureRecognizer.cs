...
namespace DigitalRubyShared
{
    ...
    public class ImageGestureImage
    {
        ...
        public string GetCodeForRowsInitialize()
        {
            ...
            System.Text.StringBuilder b = new System.Text.StringBuilder("new ImageGestureImage(new ulong[] { ");
    ...
    public class ImageGestureRecognizer : GestureRecognizer
    {
        ...
        private void AddPoint(float x, float y)
        {
            ...
            // UnityEngine.Debug.LogFormat("Point: {0},{1}, Bounds: {2},{3},{4},{5}", p.X, p.Y, minX, minY, maxX, maxY);
        }
        ...
        private void CalculateScores()
        {
            ...
            foreach (ImageGestureImage image in GestureImages)
            {
                ...
                if (similarity > lastSimilarity && similarity >= SimularityMinimum)
                {
        ...
        private bool CanExecute()
        {
            ...
            {
                if (numberOfPaths++ >= MaximumPathCount)
                {
                    numberOfPaths = 1;
        ...
        /// <summary>
        /// The maximum number of distinct paths for each image. The default is 1. Gesture will reset when max path count is hit.
        /// </summary>
        ...
        /// </summary>
        public float SimularityMinimum { get; set; }
